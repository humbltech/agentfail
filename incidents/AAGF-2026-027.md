...
damage_estimate:
  ...
  methodology: "Near-miss, mcp-server-filesystem (Anthropic reference implementation). Concurrent with mcp-server-git CVEs -- overlapping 5-month exposure window. Widespread = 50,000 developers. 50,000 x $10,000 x 0.05 = $25M."
  methodology_detail:
    per_unit_cost_usd: 10000
    unit_count: 50000
    unit_type: "Developer machines using mcp-server-filesystem reference implementation"
    multiplier: 0.05
    benchmark_source: "SANS 2024 IR Report ($10K/machine); ~30-day patch window June-July 2025"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Overlapping vulnerability window with AAGF-2026-025 (mcp-server-git) -- both Anthropic reference implementations unpatched simultaneously for ~5 months. EscapeRoute PoC demonstrated /etc/sudoers write path to RCE under elevated privileges."
