...
damage_estimate:
  ...
  recovery_cost_usd: null
  averted_damage_usd: 2500000
  averted_range_low: 250000
  averted_range_high: 25000000
  composite_damage_usd: 2500000
  confidence: "estimated"
  probability_weight: 0.01
  methodology: "Near-miss, Codex GitHub OAuth token exposure. Estimate 1,000 developer organizations with Codex GitHub OAuth integration. @codex PR review variant yields org-wide Installation Access Token. Source code exfiltration per org = $250,000 (Ponemon 2023). 1,000 x $250,000 x 0.01 = $2.5M."
  methodology_detail:
    per_unit_cost_usd: 250000
    unit_count: 1000
    unit_type: "Developer organizations with Codex GitHub OAuth integration exposed to org-wide token theft"
    multiplier: 0.01
    benchmark_source: "Ponemon 2023 IP theft study ($250K/repo); OpenAI Critical P1 classification; BeyondTrust research"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "OpenAI classified Critical P1 internally. @codex IAT org-wide scope is most severe variant. No CVE assigned. Unicode Ideographic Space obfuscation (U+3000 x94) indicates sophisticated attacker tradecraft. Unit_count uncertainty high; actual Codex developer org count not disclosed."
