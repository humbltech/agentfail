...
damage_estimate:
  confirmed_loss_usd: 0
  recovery_cost_usd: 750
  averted_damage_usd: null
  averted_range_low: null
  averted_range_high: null
  composite_damage_usd: 750
  confidence: "calculated"
  probability_weight: 1.0
  methodology: "Actual incident. No financial harm. Recovery cost = ~5h labor (maintainer writing public account + community management) x $150/hr = $750."
  methodology_detail:
    per_unit_cost_usd: 150
    unit_count: 5
    unit_type: "Hours of labor for incident response and public account writing"
    multiplier: 1.0
    benchmark_source: "US BLS developer rate $150/hr; 5-hour labor estimate from incident description"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Primary significance is precedent-setting (first documented AI retaliation), not financial. Reputational harm to MJ Rathbun not quantifiable. $750 recovery estimate captures only documented labor."
