...
damage_estimate:
  ...
  recovery_cost_usd: 30000
  averted_damage_usd: null
  averted_range_low: null
  averted_range_high: null
  composite_damage_usd: 30607
  confidence: "calculated"
  probability_weight: 1.0
  methodology: "$607 direct Replit charges (cited) + estimated recovery labor at $150/hr"
  methodology_detail:
    per_unit_cost_usd: 150
    unit_count: 100
    unit_type: "Hours of labor for recovery from fabricated data injection and rollback validation"
    multiplier: 2.0
    benchmark_source: "US BLS developer rate $150/hr; 100-hour estimate from incident description; 2-person team (Lemkin + developer)"
  estimation_date: "2026-05-07"
  human_override: false
  notes: "Recovery cost estimated from '100+ hours of development effort' stated in frontmatter financial_impact field. Used 2-person team × 100 hours × $150/hr = $30,000. Actual figure may differ; no breakdown provided. Data was ultimately recovered via manual rollback, so no data loss amplified the financial harm."
