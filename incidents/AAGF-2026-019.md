...
damage_estimate:
  confirmed_loss_usd: 607
  recovery_cost_usd: 15000
  averted_damage_usd: null
  averted_range_low: null
  averted_range_high: null
  composite_damage_usd: 15607
  confidence: "calculated"
  probability_weight: 1.0
  methodology: "Actual incident. confirmed_loss = $607.70 (Replit charges). recovery_cost = 100 hours developer labor x $150/hr = $15,000. Full data recovery achieved via rollback. Replit issued full refund. composite = 607 + 15000 = $15,607."
  methodology_detail:
    per_unit_cost_usd: 150
    unit_count: 100
    unit_type: "Hours of labor for recovery from fabricated data injection and rollback validation"
    multiplier: 1.0
    benchmark_source: "US BLS developer rate $150/hr; 100-hour estimate from incident description"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Replit issued full refund of $607.70. Data recovered via manual rollback. Labor hours sourced directly from incident report. SaaStr executive database (curated contacts) treated as fully recovered."
