...
damage_estimate:
  ...
  recovery_cost_usd: null
  averted_damage_usd: 5000
  averted_range_low: 500
  averted_range_high: 50000
  composite_damage_usd: 5000
  confidence: "estimated"
  probability_weight: 0.05
  methodology: "Near-miss, MCPJam Inspector. Team scale = 10 users (frontmatter scale: team). Dev machine $10,000 (SANS 2024). 10 x $10,000 x 0.05 = $5,000."
  methodology_detail:
    per_unit_cost_usd: 10000
    unit_count: 10
    unit_type: "Developer machines running MCPJam Inspector (team-scale inference)"
    multiplier: 0.05
    benchmark_source: "SANS 2024 IR Report ($10K/machine); team-scale inference; CVE-2026-23744 EPSS 97th percentile"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "EPSS 97th percentile and public PoC within 4 days despite smaller tool user base. Cloud dev environment (Codespaces/Gitpod) 0.0.0.0 binding makes attack trivially internet-reachable for that subset. CrowdSec detection rules published 2026-02-18."
