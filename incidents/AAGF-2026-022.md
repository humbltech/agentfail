...
agent_type:
  ...
  - "Multi-Agent System"
agent_name: "MCP STDIO Transport"
...
damage_estimate:
  ...
  recovery_cost_usd: null
  averted_damage_usd: 21000000
  averted_range_low: 7000000
  averted_range_high: 70000000
  composite_damage_usd: 21000000
  confidence: "estimated"
  probability_weight: 0.15
  methodology: "Partial, active exploitation confirmed downstream (Flowise CISA KEV). 200,000 potentially vulnerable MCP server instances. Credential rotation: 200,000 x 2 credentials x $350 = $140M potential. Probability weight 0.15 (PoC + supply chain + confirmed downstream exploitation). Averted = $140M x 0.15 = $21M."
  methodology_detail:
    per_unit_cost_usd: 700
    unit_count: 200000
    unit_type: "MCP server instances (2 credentials per instance at $350 each)"
    multiplier: 0.15
    benchmark_source: "OX Security advisory (200K vulnerable instances); industry median $350/credential; CISA KEV as exploitation confirmation"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Protocol-level flaw unpatched by Anthropic as of curation date. 9/11 marketplace registries accepted malicious PoC submissions. AAGF-2026-013 (Flowise) quantifies subset of realized damage -- not double-counted here. Ongoing tail risk from unpatched protocol not captured in point estimate."
