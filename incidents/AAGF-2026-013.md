...
damage_estimate:
  ...
  recovery_cost_usd: null
  averted_damage_usd: 8400000
  averted_range_low: 2000000
  averted_range_high: 26250000
  composite_damage_usd: 8400000
  confidence: "estimated"
  probability_weight: 0.4
  methodology: "Partial classification, active exploitation confirmed (CISA KEV). 12,000 exposed Flowise instances (conservative). Each stores ~5 LLM/cloud credentials. 12,000 x 5 x $350 = $21M potential. Probability weight 0.4 (CISA KEV confirmed). Averted = $21M x 0.4 = $8.4M."
  methodology_detail:
    per_unit_cost_usd: 1750
    unit_count: 12000
    unit_type: "Exposed Flowise instances (5 credentials per instance at $350 each)"
    multiplier: 0.4
    benchmark_source: "Censys scan data (12K-15K exposed instances); industry median $350/credential rotation; CISA KEV listing"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Third actively exploited Flowise CVE in ~12 months. Specific victim losses not publicly reported. Fortune 500 companies among Flowise users -- actual per-breach costs may exceed credential rotation alone."
