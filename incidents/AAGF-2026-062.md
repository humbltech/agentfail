...
# Vendor Response
vendor_response: "acknowledged"   # Anthropic acknowledged and formally affirmed the design; Google patched headless variant; Cursor/Microsoft no public response
vendor_response_time: "1-7 days"   # Anthropic acknowledged before publication (exact date not disclosed); estimated short window between notification and response
