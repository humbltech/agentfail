...
damage_estimate:
  ...
  averted_range_high: 964000000
  composite_damage_usd: 96400000
  confidence: "order-of-magnitude"
  probability_weight: 0.01
  methodology: "Near-miss -- syntax error prevented execution. 964,000 total extension installs. Dev machine $10,000 (SANS 2024). Wiper designed to delete local files + AWS cloud resources. 964,000 x $10,000 x 0.01 = $96.4M. >2 stacked assumptions present."
  methodology_detail:
    per_unit_cost_usd: 10000
    unit_count: 964000
    unit_type: "Developer machines with Amazon Q VS Code extension installed"
    multiplier: 0.01
    benchmark_source: "SANS 2024 IR Report ($10K/machine); Amazon Q VS Code extension install count (GitHub)"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "HUMAN REVIEW RECOMMENDED: probability_weight 0.01 reflects attacker error (syntax error), not any security control. Actual threat capability was fully deployed. Range_high $964M approaches $1B cap. AWS cloud resource destruction not separately quantified."
