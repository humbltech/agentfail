...
damage_estimate:
  ...
  recovery_cost_usd: null
  averted_damage_usd: 472500
  averted_range_low: 47250
  averted_range_high: 4725000
  composite_damage_usd: 472500
  confidence: "estimated"
  probability_weight: 0.01
  methodology: "Near-miss, OpenClaw WebSocket hijack. 135,000 GitHub stars as user proxy. Credential exfiltration: 135,000 x $350 x 1 credential avg x 0.01 = $472,500."
  methodology_detail:
    per_unit_cost_usd: 350
    unit_count: 135000
    unit_type: "OpenClaw users with API keys/OAuth tokens at risk (1 credential per user conservative estimate)"
    multiplier: 0.01
    benchmark_source: "OpenClaw GitHub stars as user proxy; industry median $350/credential rotation; government CERT advisories as severity confirmation"
  estimation_date: "2026-05-06"
  human_override: false
  notes: "Government CERTs (Belgian CCB, CNCERT) and enterprise vendors (CrowdStrike, Cisco, Microsoft) issued advisories despite no confirmed exploitation. OAuth token scope (Slack, email, calendars, cloud storage) creates downstream organizational risk beyond API key rotation."
